...
resource sqlDatabase 'Microsoft.Sql/servers/databases@2023-08-01-preview' = {
  ...
  properties: {
    ...
    // Explicitly off rather than omitted: the database was created under the
    // free offer, and leaving this to ARM's update semantics risks the free
    // limit outliving the tier it belongs to. Scaling the database keeps its
    // data — this only ends the free monthly allowance, which is one-way.
    useFreeLimit: false
  }
}
